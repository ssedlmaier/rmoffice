 ...
 * 
 */
public class CharacterNameAction implements ActionListener {
	...
	public CharacterNameAction(MetaData data, final BeanAdapter<Characteristics> characteristics, final BeanAdapter<RMSheet> sheetAdapter) {
		this.data = data;
