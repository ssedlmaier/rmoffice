...
public class ToleranceParser extends AbstractKeyFloatValueParser<TolerancePart> {
	...
	@Override
	protected TolerancePart createPart(float value) {
		return new TolerancePart(value);
	}
